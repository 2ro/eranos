      ...
      <article className="px-4 pb-8 space-y-6 text-sm text-foreground/90 leading-relaxed">
        ...
        <section className="space-y-2">
          ...
          <ul className="list-disc list-inside space-y-1 ml-2">
            <li>
              <strong>Our infrastructure:</strong> We operate the <strong>Agora relay</strong> and{' '}
              <strong>Agora Blossom server</strong>, which serve as the default relay and file host for
          ...
          <p>
            We take full responsibility for the experience within our app. On our own infrastructure (Agora relay
            and Agora Blossom server), we can directly remove content and ban offending accounts. For content
        ...
        <section className="space-y-2">
          ...
          <ul className="list-disc list-inside space-y-1 ml-2">
            ...
            <li>
              <strong>Agora relay moderation:</strong> On our own Agora relay, we actively moderate content and
              will immediately remove any CSAE material and permanently ban associated accounts.
            </li>
            <li>
              <strong>Agora Blossom server moderation:</strong> On our own Agora Blossom file server, we will
        ...
        <section className="space-y-2">
          ...
          <ul className="list-disc list-inside space-y-1 ml-2">
            ...
            <li>
              <strong>Removal from Agora infrastructure:</strong> CSAE content on the Agora relay and Agora
        ...
        <section className="space-y-2">
          ...
          <ul className="list-disc list-inside space-y-1 ml-2">
            <li>
              Provide any information available to us -- including data from the Agora relay and Agora Blossom
        ...
        <section className="space-y-2">
          ...
          <ul className="list-disc list-inside space-y-1 ml-2">
            <li>
              ...
              Agora relay and Agora Blossom server. CSAE material found on our infrastructure is deleted
