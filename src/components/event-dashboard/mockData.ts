...
export const MOCK_ACTIVITY: ActivityItem[] = [
  { id: 'a1', pubkey: 'abc1', displayName: 'María García', content: 'Participando desde Libertador. Vamos Venezuela!', created_at: now - 30, regionLabel: 'Libertador' },
  { id: 'a2', pubkey: 'abc2', displayName: 'Carlos Pérez', content: 'Reporte desde Baruta, todo en orden.', created_at: now - 90, regionLabel: 'Baruta' },
  { id: 'a3', pubkey: 'abc3', displayName: 'Ana Rodríguez', content: 'Actividad registrada en Anaco.', created_at: now - 180, regionLabel: 'Anaco' },
  { id: 'a4', pubkey: 'abc4', displayName: 'José Martínez', content: 'Verificando desde Valencia.', created_at: now - 240, regionLabel: 'Valencia' },
  { id: 'a5', pubkey: 'abc5', displayName: 'Laura Hernández', content: 'Presente desde Maracaibo, reportando sin novedad.', created_at: now - 320, regionLabel: 'Maracaibo' },
  { id: 'a6', pubkey: 'abc6', displayName: 'Pedro López', content: 'Confirmando actividad en Iribarren.', created_at: now - 410, regionLabel: 'Iribarren' },
  { id: 'a7', pubkey: 'abc7', displayName: 'Sofía Torres', content: 'Reporte enviado desde Maturín.', created_at: now - 520, regionLabel: 'Maturín' },
  { id: 'a8', pubkey: 'abc8', displayName: 'Luis Ramírez', content: 'Todo bien en San Cristóbal.', created_at: now - 640, regionLabel: 'San Cristóbal' },
  { id: 'a9', pubkey: 'abc9', displayName: 'Elena Díaz', content: 'Actividad desde Coro.', created_at: now - 780, regionLabel: 'Coro' },
  { id: 'a10', pubkey: 'abc10', displayName: 'Miguel Flores', content: 'Participación activa en Los Teques.', created_at: now - 900, regionLabel: 'Los Teques' },
  { id: 'a11', pubkey: 'abc11', displayName: 'Carmen Morales', content: 'Reporte desde Tucupita.', created_at: now - 1020, regionLabel: 'Tucupita' },
  { id: 'a12', pubkey: 'abc12', displayName: 'Roberto Silva', content: 'Verificando en San Carlos.', created_at: now - 1150, regionLabel: 'San Carlos' },
  { id: 'a13', pubkey: 'abc13', displayName: 'Patricia Gómez', content: 'Desde San Fernando, todo en calma.', created_at: now - 1280, regionLabel: 'San Fernando' },
  { id: 'a14', pubkey: 'abc14', displayName: 'Fernando Castro', content: 'Presente en Guanare.', created_at: now - 1400, regionLabel: 'Guanare' },
  { id: 'a15', pubkey: 'abc15', displayName: 'Daniela Vargas', content: 'Actividad reportada desde La Asunción.', created_at: now - 1550, regionLabel: 'La Asunción' },
];
