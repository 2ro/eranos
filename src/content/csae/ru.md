...
- **Свяжитесь с нами напрямую:** Обратитесь к нашей команде на [goblin.st/team](https://goblin.st/team) с подробностями контента, включая любые соответствующие ID событий Nostr или публичные ключи.
...
Если вы считаете, что ваш контент или аккаунт были неправильно отмечены или заблокированы в соответствии с этой политикой, вы можете связаться с нами на [goblin.st/team](https://goblin.st/team), чтобы запросить проверку. Мы будем оценивать апелляции в каждом конкретном случае. Однако мы склоняемся в сторону безопасности детей во всех решениях, и наше решение является окончательным.
...
По вопросам об этой политике или для сообщения о контенте CSAE свяжитесь с командой за {{appName}} на [goblin.st/team](https://goblin.st/team).
